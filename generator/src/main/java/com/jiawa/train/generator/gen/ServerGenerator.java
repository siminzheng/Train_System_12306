...
//        gen(Domain, param, "service/admin", "service");
//        gen(Domain, param, "controller/admin", "controller");
//        gen(Domain, param, "controller/admin", "adminController");
//        gen(Domain, param, "req/admin", "saveReq");
//        gen(Domain, param, "req/admin", "queryReq");
//        gen(Domain, param, "resp/admin", "queryResp");
